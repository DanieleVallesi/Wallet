...
public class WalletController {
    ...
    public @ResponseBody ResponseEntity<Object> changeUserBalance(@RequestBody ChangeBalanceRequest body){
    ...
    public @ResponseBody ResponseEntity<Object> getTransactionHistory(@RequestParam String userUuid){
        return new ResponseEntity<>(walletService.getTransactionHistory(userUuid), HttpStatus.OK) ;
    }

    @GetMapping(path = "/get-user-balance")
    public @ResponseBody ResponseEntity<Object> getUserBalance(@RequestParam String userUuid){
        return new ResponseEntity<>(walletService.getUserBalance(userUuid), HttpStatus.OK) ;
    }

    @PostMapping(path = "/create-user")
    public @ResponseBody ResponseEntity<Object> createUser(@Valid @RequestBody CreateUserRequest createUserRequest) {
